...
Please use the appropriate [Gitmoji](https://gitmoji.carloscuesta.me) for commiting.
...
* You can try running `npm run lint` for style unification (this is a work in progress)
